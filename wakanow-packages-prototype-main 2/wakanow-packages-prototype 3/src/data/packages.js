...
const DOHA = {
  ...
  // `channel` marks inventory contracted through Discover Qatar. It is what the
  // Qatar fulfilment rule filters on for restricted passports — see
  // src/data/fulfilment.js. Al Najada carries no channel, so it is sellable to
  // a UK passport and not to a Nigerian one, which is the whole rule in one row.
  hotels: [
    { id: 'mond', name: 'Mondrian Doha · 5★', desc: 'Studio room · breakfast · West Bay', meta: 'Studio room · breakfast included · West Bay', nightly: 112000, nightlySeparate: 124000, eligible: true, channel: 'Discover Qatar' },
    ...
    { id: 'ritz', name: 'The Ritz-Carlton Doha · 5★', desc: 'Marina room · half board · private beach', meta: 'Marina-view room · half board · private beach and marina', nightly: 168000, nightlySeparate: 186000, eligible: true, channel: 'Discover Qatar' },
    { id: 'alwadi', name: 'Al Wadi Hotel Doha · 4★', desc: 'Deluxe room · breakfast · Msheireb', meta: 'Deluxe room · breakfast included · Msheireb Downtown', nightly: 78000, nightlySeparate: 88000, eligible: true, channel: 'Discover Qatar' },
  ],
...
/**
 * Singapore is in the catalogue for a specific reason: it is the second
 * Destination Fulfilment Rule, and it is the one that proves the rule is a
 * table rather than a Qatar special case. Nothing about its inventory is
 * constrained — every hotel here is sellable to every passport. Only the visa
 * is routed, because Singapore will not accept an application filed directly
 * by a Nigeria passport holder. See src/data/fulfilment.js.
 */
const SINGAPORE = {
  slug: 'singapore-city-stopover',
  name: 'Singapore stopover',
  city: 'Singapore', code: 'SIN', country: 'Singapore',
  nights: 4, vibes: ['City Break', 'Food & Nightlife'], visa: 'required', freeCancelDays: 14,
  blurb: 'Four nights on Marina Bay, hawker centres, and the gardens after dark.',
  gradient: g('#0A3A4A', '#1E8A9A', '#E8C46A'),
  gallery: [
    { caption: 'Marina Bay', gradient: g('#0A3A4A', '#1E8A9A', '#E8C46A') },
    { caption: 'Parkroyal Collection — deluxe room', gradient: 'linear-gradient(150deg,#123A4A,#3E8A96)' },
    { caption: 'Gardens by the Bay', gradient: 'linear-gradient(150deg,#0C3A2A,#4A9A6A)' },
    { caption: 'Maxwell hawker centre', gradient: 'linear-gradient(150deg,#4A2A1E,#C08A4A)' },
    { caption: 'Sentosa', gradient: 'linear-gradient(150deg,#1E3A5C,#6AA8C8)' },
  ],
  flights: [
    { id: 'ek', name: 'Emirates · 1 stop Dubai', desc: 'LOS 22:40 → SIN 20:05 · 19h 25m · 2 bags', meta: 'Lagos (LOS) → Dubai (DXB) → Singapore (SIN) · Economy · 2 checked bags', price: 1486000, separate: 1632000, eligible: true },
    { id: 'qr', name: 'Qatar Airways · 1 stop Doha', desc: 'LOS 15:10 → SIN 17:30 · 18h 20m · 2 bags', meta: 'Lagos (LOS) → Doha (DOH) → Singapore (SIN) · Economy · 2 checked bags', price: 1542000, separate: 1698000, eligible: true },
    { id: 'tk', name: 'Turkish Airlines · 1 stop Istanbul', desc: 'LOS 05:45 → SIN 18:40 · 21h 55m · 2 bags', meta: 'Lagos (LOS) → Istanbul (IST) → Singapore (SIN) · Economy · 2 checked bags', price: 1398000, separate: 1398000, eligible: false },
  ],
  hotels: [
    { id: 'parkroyal', name: 'Parkroyal Collection Marina Bay · 5★', desc: 'Deluxe room · breakfast · on the bay', meta: 'Deluxe room · breakfast included · overlooking Marina Bay', nightly: 128000, nightlySeparate: 142000, eligible: true },
    { id: 'hotelg', name: 'Hotel G Singapore · 4★', desc: 'Good room · room only · Bencoolen', meta: 'Good room · room only · Bencoolen, two stops from the bay', nightly: 72000, nightlySeparate: 82000, eligible: true },
    { id: 'mbs', name: 'Marina Bay Sands · 5★', desc: 'Deluxe room · breakfast · infinity pool', meta: 'Deluxe room · breakfast · rooftop infinity pool and SkyPark', nightly: 236000, nightlySeparate: 262000, eligible: true },
  ],
  transfer: { name: 'Private airport transfers', desc: 'Both ways · meet and greet at Changi', price: 52000, separate: 61000 },
  addons: [
    { id: 'visa', title: 'Singapore entry visa', meta: 'Filed by our authorised agent — Singapore does not accept direct applications · 5–10 working days', price: 74000, separate: 88000 },
    { id: 'gardens', title: 'Gardens by the Bay — both conservatories', meta: 'Cloud Forest and Flower Dome · timed entry · evening light show', price: 34000, separate: 41000 },
    { id: 'sentosa', title: 'Sentosa day pass with cable car', meta: 'Cable car both ways, beaches and the boardwalk · full day', price: 46000, separate: 55000 },
  ],
  itinerary: [
    { title: 'Overnight flight and check-in.', body: 'Land at Changi in the evening, driver waiting, twenty minutes to the bay.' },
    { title: 'Marina Bay.', body: 'The gardens in the afternoon, the conservatories before the light show at dusk.' },
    { title: 'Hawker day.', body: 'Maxwell and Chinatown in the morning, Little India and Kampong Glam after.' },
    { title: 'Sentosa.', body: 'Cable car over, the beaches and the boardwalk, back for the evening.' },
    { title: 'Late checkout and departure.', body: 'Room held until the afternoon, transfer to Changi for the flight home.' },
  ],
};
...
export const CATALOGUE = [
  ...
  CAIRO, DOHA, SINGAPORE, MAURITIUS, KIGALI,
];
